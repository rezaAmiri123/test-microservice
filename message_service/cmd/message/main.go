...
func setupFlags(cmd *cobra.Command) error {
	...
	cmd.Flags().String("mongo-username", "admin", "database username.")
	cmd.Flags().String("mongo-password", "admin", "mongo password.")
	cmd.Flags().String("mongo-uri", "mongodb://mongodb:27017", "database URI.")
	cmd.Flags().String("mongo-database", "messages", "database name.")
...
func (c *cli) setupConfig(cmd *cobra.Command, args []string) error {
	...
	c.cfg.MongoConfig.User = viper.GetString("mongo-username")
	c.cfg.MongoConfig.Password = viper.GetString("mongo-password")
	c.cfg.MongoConfig.URI = viper.GetString("mongo-uri")
	c.cfg.MongoConfig.DB = viper.GetString("mongo-database")
